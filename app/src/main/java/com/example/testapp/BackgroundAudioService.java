...
// Extend VolumeProviderCompat with your own implementation.
    ...
    private void showPlayingNotification() {
        NotificationCompat.Builder builder = com.example.testapp.MediaStyleHelper.from(BackgroundAudioService.this, mMediaSessionCompat);
        if( builder == null ) {
            return;
        }
    ...
    private void showPausedNotification() {
        NotificationCompat.Builder builder = com.example.testapp.MediaStyleHelper.from(this, mMediaSessionCompat);
        if( builder == null ) {
            return;
        }
    ...
    private void setMediaPlaybackState(int state) {
        Builder playbackBuilder = new Builder();
        ...
        playbackBuilder.setState(state, PlaybackStateCompat.PLAYBACK_POSITION_UNKNOWN, 0);
        mMediaSessionCompat.setPlaybackState(playbackBuilder.build());
    }
